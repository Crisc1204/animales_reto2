...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadInfo() {
        ...
        animalesList.add(new Animales(R.drawable.perro1, "Perro", "El perro es un animal de tipo canino y se dice que es fiel amigo del hombre", R.raw.perro));
        ...
        animalesList.add(new Animales(R.drawable.vaca, "Vaca", "La vaca es un animal de tipo mamífero criado por el ser humano para aprovechar su carne, leche y cuero por lo geenral.", R.raw.vaca));
        animalesList.add(new Animales(R.drawable.cerdo, "Cerdo", "El Cerdo es un animal de tipo mamífero y se trata de un cuadrúpedo con patas cortas, pezuñas, cuerpo pesado, hocico flexible y cola corta.", R.raw.cerdo));
